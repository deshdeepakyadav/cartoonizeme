...
import com.app.cartoonizeme.filter.service.FileStorageService;
import com.app.cartoonizeme.filter.util.UploadFileResponse;
...
public class FileController {
	...
	public String welcome() {
		...
		System.out.println();
		return "Welcome to Cartoonize Me !";
	}
